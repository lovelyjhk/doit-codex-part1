...
첫째마당의 파이썬 예제는 Python 3의 기본 기능만 사용합니다. 둘째마당의 일부 파일 처리·엑셀·그래프 예제에는 Pillow, openpyxl, matplotlib 등의 패키지가 필요할 수 있습니다. 해당 실습의 README와 requirements.txt에 적힌 패키지만 설치하세요. 문서 요약과 후보표 작성은 파이썬 코드 실행 없이 진행할 수 있습니다.
